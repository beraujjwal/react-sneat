...
import MenuItem from '../elements/ui/menu/MenuItem';
    ...
    return (      
      <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul className="menu-inner py-1">
          <MenuItem name="Dashboard" path="/dashboard" icon="bx-home-circle" />
          
          <MenuItem name="Layouts" path="#" icon="bx-layout">
            <MenuItem name="Without menu" path="/without-menu" />
            <MenuItem name="Without navbar" path="/without-navbar" />
            <MenuItem name="Container" path="/container" />
            <MenuItem name="Fluid" path="/fluid" />
            <MenuItem name="Blank" path="/blank" />
          </MenuItem>
